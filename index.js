function calcRank(victories, defeats) {
    ...
    return `O Herói tem de saldo de ${dif} está no nível de ${level}`;
}

const playerVictories = 95;
const playerDefeats = 10;
const lastRank = calcRank(playerVictories, playerDefeats);
